...
date.end = format(Sys.time(),format = '%y%m%d')
...
dates.thurs = format(seq(as.Date(date.start.thurs,datefmtstr),as.Date(date.end,datefmtstr),by = "week"), format = datefmtstr)
dates = c(dates.wed,dates.thurs)
